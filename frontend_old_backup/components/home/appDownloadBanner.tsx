            ...
            <div className="flex flex-wrap gap-4 mt-8">
             <div className="col-6 col-sm-4 col-md-3">
                                <Link href="https://play.google.com/store/apps/details?id=com.lifeplus.onetapservice" target="_blank">
                                    <Image src="/img/google-play.svg" className="btn-transition" width={100} height={40} alt="google-store"/>
                                </Link>
                            </div>

              <div className="col-6 col-sm-4 col-md-3">
                <Link href="https://apps.apple.com/us/app/one-tap-service/id6745725043">
                  <Image src="/img/app-store.svg" className="btn-transition" width={120} height={40} alt="app-store"/>
                </Link>
              </div>
            </div>
          </div>

...
export default function BlogIndexPage() {
  ...
  const categories = ['All', 'Appliance Care', 'Home Cleaning', 'Electrical', 'Plumbing', 'Shifting & Moving'];
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-10 text-center">
            ...
            <p className="mx-auto mt-2 max-w-2xl text-sm text-muted-foreground sm:text-base">
              Practical guides, DIY maintenance advice, and home service trends curated by professional technicians.
            </p>

            {/* Search Bar */}
            <div className="mx-auto mt-6 max-w-md relative">
              <FiSearch className="absolute left-3.5 top-1/2 -translate-y-1/2 text-muted-foreground" size={18} />
              <input
                type="text"
                value={search}
          ...
          {filtered.length === 0 && (
            <div className="py-16 text-center text-muted-foreground">
              <p className="text-base">No articles found matching &quot;{search}&quot;</p>
            </div>
          )}
        </div>
      </main>
